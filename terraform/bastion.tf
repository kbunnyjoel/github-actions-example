...
resource "null_resource" "bastion_config" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # THIS LINE OVERWRITES THE KUBECONFIG GENERATED BY USER DATA
      "echo '${base64encode(local_file.kubeconfig.content)}' | base64 -d > /home/ec2-user/.kube/config",
      "chmod 600 /home/ec2-user/.kube/config",
      "sudo mkdir -p /root/.kube",
      # THIS COPIES THE OVERWRITTEN KUBECONFIG TO ROOT
